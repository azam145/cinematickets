...
class ValidatorServiceImplTest {
    ...
    void validateTickets_ExceedsMaxTickets_ThrowsException() {
        // Given
        when(configurationService.getMaxTickets()).thenReturn(25); // Mock max tickets

        TicketTypeRequest adultRequest = new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 26); // Exceed max
    ...
    void validateTickets_NoAdultTicket_ThrowsException() {
        // Given
        when(configurationService.getMaxTickets()).thenReturn(25);
